...
# Example usage
# ./run_training_woodwinds.sh --train_on ensembleset --tag ensembleset_woodwinds

# General
train_on=synthsod   # Controls the dataset used for training (synthsod or ensembleset)
tag=synthsod_woodwinds  # Controls the directory name associated to the experiment
